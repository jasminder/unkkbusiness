...
class DeleteProposalWidget extends StatefulWidget {
  const DeleteProposalWidget({
    super.key,
    this.trackRef,
  });

  final DocumentReference? trackRef;
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  _model.trackInfo =
                                      await ClientTrackRecord.getDocumentOnce(
                                          widget.trackRef!);
                                  while (
                                      _model.trackInfo!.clientServices.length >
                                          _model.loop) {
                                    await _model
                                        .trackInfo!.clientServices[_model.loop]
                                        .delete();
                                    setState(() {
                                      _model.loop = _model.loop + 1;
                                    });
                                  }
                                  await widget.trackRef!.delete();
                                  Navigator.pop(context);
