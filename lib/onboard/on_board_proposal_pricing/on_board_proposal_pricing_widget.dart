...
import 'on_board_proposal_pricing_model.dart';
export 'on_board_proposal_pricing_model.dart';

class OnBoardProposalPricingWidget extends StatefulWidget {
  ...
  State<OnBoardProposalPricingWidget> createState() =>
      _OnBoardProposalPricingWidgetState();
}

class _OnBoardProposalPricingWidgetState
    extends State<OnBoardProposalPricingWidget> {
  late OnBoardProposalPricingModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnBoardProposalPricingModel());
                                                                      ...
                                                                      child:
                                                                        ...
                                                                        children: [
                                                                          ...
                                                                          StreamBuilder<
                                                                            ...
                                                                            stream:
                                                                                queryServicesTaskRecord(
                                                                              queryBuilder: (servicesTaskRecord) => servicesTaskRecord.where(
                                                                                'serviceRef',
                                                                                isEqualTo: containerClientServicesRecord.serviceRef,
                                                                              ),
                                                                            ),
                                                                            builder:
                                                                                (context, snapshot) {
