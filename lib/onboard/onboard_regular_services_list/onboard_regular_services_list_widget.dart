...
class OnboardRegularServicesListWidget extends StatefulWidget {
  const OnboardRegularServicesListWidget({super.key});

  @override
  State<OnboardRegularServicesListWidget> createState() =>
      _OnboardRegularServicesListWidgetState();
}

class _OnboardRegularServicesListWidgetState
    extends State<OnboardRegularServicesListWidget> {
  late OnboardRegularServicesListModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardRegularServicesListModel());
