...
class OnboardServiceTermsWidget extends StatefulWidget {
  const OnboardServiceTermsWidget({
    super.key,
  ...
  State<OnboardServiceTermsWidget> createState() =>
      _OnboardServiceTermsWidgetState();
}

class _OnboardServiceTermsWidgetState extends State<OnboardServiceTermsWidget> {
  late OnboardServiceTermsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => OnboardServiceTermsModel());
