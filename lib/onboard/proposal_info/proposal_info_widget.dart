...
import 'proposal_info_model.dart';
export 'proposal_info_model.dart';

class ProposalInfoWidget extends StatefulWidget {
  const ProposalInfoWidget({
    super.key,
    this.clientTrack,
  });

  final ClientTrackRecord? clientTrack;

  @override
  State<ProposalInfoWidget> createState() => _ProposalInfoWidgetState();
}

class _ProposalInfoWidgetState extends State<ProposalInfoWidget> {
  late ProposalInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProposalInfoModel());
