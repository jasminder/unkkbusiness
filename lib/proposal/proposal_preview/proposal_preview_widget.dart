...
import 'proposal_preview_model.dart';
export 'proposal_preview_model.dart';

class ProposalPreviewWidget extends StatefulWidget {
  const ProposalPreviewWidget({super.key});

  @override
  State<ProposalPreviewWidget> createState() => _ProposalPreviewWidgetState();
}

class _ProposalPreviewWidgetState extends State<ProposalPreviewWidget> {
  late ProposalPreviewModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ProposalPreviewModel());
