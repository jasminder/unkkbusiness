...
class _AddServiceWidgetState extends State<AddServiceWidget> {
  ...
  void initState() {
    ...
    _model.serviceController1 ??= TextEditingController();
    _model.serviceFocusNode1 ??= FocusNode();

    _model.serviceController2 ??= TextEditingController();
    _model.serviceFocusNode2 ??= FocusNode();
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller: _model.serviceController1,
                                        focusNode: _model.serviceFocusNode1,
                                        obscureText: false,
                                ...
                                Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      TextFormField(
                                        controller: _model.serviceController2,
                                        focusNode: _model.serviceFocusNode2,
                                        obscureText: false,
                                        decoration: InputDecoration(
                                          isDense: true,
                          ...
                          FFButtonWidget(
                            onPressed: () async {
                              ...
                              await servicesRecordReference
                                ...
                                name: _model.serviceController1.text,
                                description: _model.serviceController2.text,
                                price: double.tryParse(
                                    _model.priceController.text),
                                taxRate: _model.taxRateValue,
                                createdAt: getCurrentTimestamp,
                              ));
                              _model.createdService =
                                  ServicesRecord.getDocumentFromData(
                                      createServicesRecordData(
                                        name: _model.serviceController1.text,
                                        description:
                                            _model.serviceController2.text,
                                        price: double.tryParse(
                                            _model.priceController.text),
                                        taxRate: _model.taxRateValue,
                                        createdAt: getCurrentTimestamp,
                              ...
                              context.goNamed(
                                ...
                                queryParameters: {
                                  'serviceRef': serializeParam(
                                    _model.createdService?.reference,
