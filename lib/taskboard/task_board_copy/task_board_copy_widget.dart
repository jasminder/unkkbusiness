...
import 'task_board_copy_model.dart';
export 'task_board_copy_model.dart';

class TaskBoardCopyWidget extends StatefulWidget {
  const TaskBoardCopyWidget({super.key});

  @override
  State<TaskBoardCopyWidget> createState() => _TaskBoardCopyWidgetState();
}

class _TaskBoardCopyWidgetState extends State<TaskBoardCopyWidget> {
  late TaskBoardCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => TaskBoardCopyModel());
